...
namespace Danish.Widget.Services;
...
public class AudioService : IDisposable
{
    ...
    {
        await PlayLocalSoundAsync("avares://Danish.Widget/Assets/Sounds/correct.mp3");
    }
    ...
    {
        await PlayLocalSoundAsync("avares://Danish.Widget/Assets/Sounds/wrong.mp3");
    }
