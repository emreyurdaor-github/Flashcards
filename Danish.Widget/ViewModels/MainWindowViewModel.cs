...
using Danish.Widget.Services;

namespace Danish.Widget.ViewModels;
...
public partial class MainWindowViewModel : ViewModelBase, IDisposable
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        // Populate with your Danish → English pairs, e.g.:
         ...
         { "kræft", "cancer"},
         { "opdages", "discovered"},
         { "sygemeldt", "sick leave"},
         { "reagere", "react"},
         { "behøver", "have to/need to"},
         { "undersøge", "examine"},
         { "undersøger", "examine"},
         { "situationen", "the situation"},
         { "teknologien", "technology/the technology"},
         { "offentlige", "publig"},
         { "ulighed", "inequality"},
         ...
         { "passer", "look after"},
         { "alder", "age"},
         { "selvstændige", "independent"},
         { "forbereder", "prepares"},
         { "tilbringe", "spend"},
         { "føler", "feel"},
         { "tryghed", "security"},
         { "undgå", "avoid"},
         { "afleveringer", "drop-offs"},
         { "glip af", "misses out"},
         { "erfaring", "experience"},
         { "chok", "shock"},
         { "pludselig", "suddenly"},
         ...
         { "sker", "happens"},
         { "stemning", "atmosphere"},
         { "forståelse", "understand"},
         { "forholdet", "relationship"},
         { "ulempe", "disadvantage"},
         { "sandhed", "truth"},
         { "løgn", "lies"},
         { "artikler", "articles"},
         ...
         { "sagen", "case/the case"},
         { "fysisk", "physical"},
         { "kostråd", "dietary guidelines"},
         { "følger", "follows"},
         { "rådene", "the advice"},
         { "færdigretter", "ready-made meals"},
         { "indeholder", "contain"},
         { "blandt", "among"},
         { "folkesundheden", "public health"},
         { "folkefærd", "people"},
         { "udfordring", "challenge"},
         { "stillesiddende", "sedentary"},
         { "føre", "lead"},
         { "livsstilssygdomme", "lifestyle diseases"},
         { "Dernæst", "Next"},
